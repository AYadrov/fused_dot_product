...
static inline uint_fast16_t q_add(uint_fast16_t arg_0, uint_fast16_t arg_1) {  // q_add
    ...
    const uint_fast16_t tmp_192 = uint_fast16_t(tmp_191[0] & 65535);  // basic_get_item_0
    const uint_fast16_t tmp_193 = uint_fast16_t(tmp_191[1] & 65535);  // basic_get_item_1
...
static inline uint_fast16_t CSA_tree4_impl(uint_fast8_t arg_0, uint_fast16_t arg_1, uint_fast8_t arg_2, uint_fast8_t arg_3) {  // CSA_tree4
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_11 = uint_fast16_t(tmp_10[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_12 = uint_fast16_t(tmp_10[1] & 4095);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_25 = uint_fast16_t(tmp_24[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_26 = uint_fast16_t(tmp_24[1] & 4095);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_33 = uint_fast16_t(tmp_32[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_34 = uint_fast16_t(tmp_32[1] & 4095);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_46 = uint_fast16_t(tmp_45[0] & 511);  // basic_get_item_0
    const uint_fast16_t tmp_47 = uint_fast16_t(tmp_45[1] & 511);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_54 = uint_fast16_t(tmp_53[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_55 = uint_fast16_t(tmp_53[1] & 4095);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_68 = uint_fast16_t(tmp_67[0] & 2047);  // basic_get_item_0
    const uint_fast16_t tmp_69 = uint_fast16_t(tmp_67[1] & 2047);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_76 = uint_fast16_t(tmp_75[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_77 = uint_fast16_t(tmp_75[1] & 4095);  // basic_get_item_1
    ...
    const uint_fast16_t tmp_89 = uint_fast16_t(tmp_88[0] & 4095);  // basic_get_item_0
    const uint_fast16_t tmp_90 = uint_fast16_t(tmp_88[1] & 8191);  // basic_get_item_1
    // begin inline primitive CSA
    // begin inline primitive q_aligner
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_102 = uint_fast16_t(tmp_101[0] & 8191);  // basic_get_item_0
    const uint_fast16_t tmp_103 = uint_fast16_t(tmp_101[1] & 8191);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_116 = uint_fast16_t(tmp_115[0] & 16383);  // basic_get_item_0
    const uint_fast16_t tmp_117 = uint_fast16_t(tmp_115[1] & 16383);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_124 = uint_fast16_t(tmp_123[0] & 8191);  // basic_get_item_0
    const uint_fast16_t tmp_125 = uint_fast16_t(tmp_123[1] & 8191);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_137 = uint_fast16_t(tmp_136[0] & 16383);  // basic_get_item_0
    const uint_fast16_t tmp_138 = uint_fast16_t(tmp_136[1] & 16383);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_145 = uint_fast16_t(tmp_144[0] & 16383);  // basic_get_item_0
    const uint_fast16_t tmp_146 = uint_fast16_t(tmp_144[1] & 16383);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_153 = uint_fast16_t(tmp_152[0] & 8191);  // basic_get_item_0
    const uint_fast16_t tmp_154 = uint_fast16_t(tmp_152[1] & 8191);  // basic_get_item_1
    ...
    // end inline primitive q_aligner
    const uint_fast16_t tmp_161 = uint_fast16_t(tmp_160[0] & 16383);  // basic_get_item_0
    const uint_fast16_t tmp_162 = uint_fast16_t(tmp_160[1] & 16383);  // basic_get_item_1
    ...
    // end inline primitive CSA
    const uint_fast16_t tmp_174 = uint_fast16_t(tmp_173[0] & 16383);  // basic_get_item_0
    const uint_fast16_t tmp_175 = uint_fast16_t(tmp_173[1] & 32767);  // basic_get_item_1
